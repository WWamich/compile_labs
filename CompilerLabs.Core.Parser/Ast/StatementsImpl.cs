...
namespace CompilerLabs.Core.Parser.Ast
{
    ...
    /// <summary>
    /// Объявление функции: func add(a, b) { return a + b; }
    /// </summary>
    public class FunctionStatement : Statement
    {
        ...
        public FunctionStatement(string name, List<string> parameters, BlockStatement body, int line, int column) : base(line, column)
        {
            Name = name;
    ...
    /// <summary>
    /// Отдельный statement для вызова функции: foo(1, 2);
    /// </summary>
    public class CallStatement : Statement
    {
        public CallExpression Call { get; }

        public CallStatement(CallExpression call, int line, int column) : base(line, column)
        {
            Call = call;
        }
    }
